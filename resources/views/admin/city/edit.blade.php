...
<div class="page">
      <div class="page-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Edit Neighborhoods</li>
        </ol>
...
@endif
                    ...
                    <form method="POST" action="{{ url('edit_city') }}" id="add_form">
                      ...
                      <div class="row">
                        <div class="form-group form-material col-md-6">
                          ...
                          <input type="text" class="form-control city_name" id="inputBasicFirstName" name="city_name"
                            placeholder="" autocomplete="off" value="@if(isset($editview->city_name)){{ $editview->city_name }}@else{{old('city_name')}}@endif" />
