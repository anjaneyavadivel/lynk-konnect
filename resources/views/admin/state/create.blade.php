...
@endif
                    ...
                    <form method="POST" action="{{ url('add_state') }}" id="add_form">
                      @csrf
                      <input type="hidden" name="country_id" value="1">
                      <!-- <div class="row">
                        <div class="form-group form-material col-md-6">
                          <label class="form-control-label" for="inputBasicFirstName">Country</label>
                            <select class="form-control" id="select" name="country_id">
                              <option value="">Select</option>
                              @foreach ($countryList as $Cval)
                              <option value="{{ $Cval->id }}">{{ $Cval->country_name }}</option>
                              @endforeach
                            </select>
                      ...
                      <div class="row">
                        <div class="form-group form-material col-md-6">
                          ...
                          <input type="text" class="form-control country_name" id="inputBasicFirstName" name="state_name"
