                    ...
                    <div class="form-row">
                      ...
                      <div class="form-row">
                        ...
                        <div class="form-group form-material col-md-4"  style="margin-bottom:0px;">
                            ...
                            <input name="from_longitude" class="from-long form-control" value="<?php  echo $editview->from_longitude; ?>" type="text" placeholder="Longitude"  readonly>
                      ...
                      <div class="form-row">                        
                        ...
                        <div class="form-group form-material col-md-4"  style="margin-bottom:0px;">
                          ...
                          <input name="to_longitude" class="to-long form-control"value="<?php  echo $editview->to_longitude; ?>" type="text" placeholder="Longitude" readonly>
