                        ...
                        <div class="form-group form-material col-md-6">
                          <label class="form-control-label" for="inputBasicFirstName">Company</label>
                           <select class="form-control operator" id="select" name="company_id">
                              ...
                              <option value="{{ $Cval->id }}" @if($usereditview->company_id==$Cval->id) selected @endif>{{ $Cval->company_name }}</option>
                              @endforeach
                            </select>
                    ...
                    <?php } ?>
                      <div class="row">
                        <div class="form-group form-material col-md-6">
                          ...
                          <input type="text" class="form-control fname" id="inputBasicFirstName" name="fname" value="{{$usereditview->fname}}"
                        ...
                        <div class="form-group form-material col-md-6">
                          ...
                          <input type="text" class="form-control" id="inputBasicLastName" name="lname" value="{{$usereditview->lname}}"
                      ...
                      <div class="form-group form-material">
                        ...
                        <input type="email" class="form-control email" name="email" value="{{$usereditview->email}}"
                ...
                <div class="example-wrap">
                  ...
                  <div class="example">
                      ...
                      <div class="form-group form-material">
                        ...
                        <textarea class="form-control address1" id="inputBasicFirstName" name="address1" value="{{$editview->address1}}" cols="2">{{$editview->address1}}</textarea>
                      ...
                      <div class="form-group form-material">
                        ...
                        <textarea class="form-control" id="inputBasicFirstName" name="address2"  placeholder="" autocomplete="off">{{$editview->address2}}</textarea>
                      </div>
                      <div class="form-row">
                        <div class="form-group form-material col-md-6">
                          ...
                          <select class="form-control country" id="state_id" name="state_id">
                              ...
                              <option value="{{ $Sval->id }}" @if($editview->state_id==$Sval->id) selected @endif>{{ $Sval->state_name }}</option>
                              @endforeach
                          </select>
                        ...
                        <div class="form-group form-material col-md-6">
                          ...
                          <select class="form-control city_id1" id="city_id" name="city_id">
                              ...
                              <option value="{{ $Sval->id }}" @if($editview->city_id==$Sval->id) selected @endif>{{ $Sval->city_name }}</option>
                              @endforeach
                          </select>
