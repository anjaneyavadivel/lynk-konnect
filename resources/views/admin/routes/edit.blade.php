...
@endif
                    <form method="POST" action="{{ url('edit_route') }}">
                      ...
                      <div class="row">
                        <div class="form-group form-material col-md-6">
                          <label class="form-control-label" for="inputBasicFirstName">Route name</label>
                            <input class="form-control" type="text" id="route_name" name="route_name" value="{{ $editview->route_name }}">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="form-group form-material col-md-6">
                          <label class="form-control-label" for="inputBasicFirstName">Description</label>
                            <textarea class="form-control" id="description" name="description" placeholder="" autocomplete="off">{{ $editview->description }}</textarea>
                        </div>
                      </div>
