...
require("{{url('/')}}/public/")
},{"{{url('/')}}/public/":2}],2:[function(require,module,exports){
...
script.src =
  "https://maps.googleapis.com/maps/api/js?key=AIzaSyA4yR0QYbk-PSt19ImAdnw3nKHWfTvhXRo&callback=initMap&libraries=places";
script.defer = true;
